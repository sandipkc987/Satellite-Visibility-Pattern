...
excelRaw       = fullfile(saveFolder, 'highest_elevation_handover.xlsx');
excelFormatted = fullfile(saveFolder, 'handover_reformatted.xlsx');
matOut         = fullfile(saveFolder, 'highest_elevation_handover.mat');
